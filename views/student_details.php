         ...
         <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
               <ul class="nav navbar-nav side-nav bs-docs-sidebar" id="sidebar">
                  ...
                  <li>
                     <a href="bootstrap-grid.html"><i class="fa fa-fw fa-wrench"></i> Available Times</a>
                  </li>
                  <li>
                     <a href="bootstrap-grid.html"><i class="fa fa-fw fa-edit"></i> Send Report To HOD</a>
                  </li>
                  <li>
                     ...
                     <ul id="demo" class="collapse">
                        <li>
                           <a href="#"><i class="fa fa-fw fa-bar-chart-o"></i> Kingston Coker</a>
                        </li>
                        <li>
                           <a href="#"><i class="fa fa-fw fa-bar-chart-o"></i> Kutorkor  Kotey-Afutu</a>
                        </li>
                        <li>
                           <a href="#"><i class="fa fa-fw fa-bar-chart-o"></i> Iddris Mushin Adualai</a>
                        </li>
                        <li>
                           <a href="#"><i class="fa fa-fw fa-bar-chart-o"></i> Margaret Kumi</a>
                        </li>
                        <li>
                           <a href="#"><i class="fa fa-fw fa-bar-chart-o"></i> Selassie Adzudzor</a>
                        </li>
                     </ul>
                  </li>

                  <!--                  <li>
                                       <a href="charts.html"><i class="fa fa-fw fa-bar-chart-o"></i> Kingston Coker</a>
                                    </li>
                                    <li>
                                       <a href="tables.html"><i class="fa fa-fw fa-table"></i> Kutorkor  Kotey-Afutu</a>
                                    </li>
                                    <li>
                                       <a href="forms.html"><i class="fa fa-fw fa-edit"></i> Iddris Mushin Adualai</a>
                                    </li>
                                    <li>
                                       <a href="bootstrap-elements.html"><i class="fa fa-fw fa-desktop"></i> Margaret Kumi</a>
                                    </li>
                                    <li>
