        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">Advisory System</a>
                </div>
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-fw fa-arrows-v"></i> Your Advisees <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="demo" class="collapse">
                            <li>
                                <a href="#">Abdul Muhsin Iddris</a>
                            </li>
                            <li>
                                <a href="#">Barbara Selassie Adzudzor</a>
                            </li>
                            <li>
                                <a href="#">Kingston Coker</a>
                            </li>
                            <li>
                                <a href="#">Kutorkor Kotey-Afutu</a>
                            </li>
                            <li>
                                <a href="#">Martha Adjoa Ataa Kumi</a>
                            </li>
                        </ul>
                        </li>      
