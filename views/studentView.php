...
<html lang="en">
    ...
    <body>
        ...
        $obj = new advisor_class();
        $obj->get_student_has_advisor_id_by_student_id($student_id);
        $row = $obj->fetch();
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading top-bar">
                                        <div class="col-md-8 col-xs-8">
                                            <h3 class="panel-title"><span class="glyphicon glyphicon-comment"></span> Send Message</h3>
                                        </div>
                                    ...
                                    <div class="panel-body msg_container_base">
                                        ...
                                        $obj_message->get_all_messages($student_has_advisor_id);
                                        $row_message = $obj_message->fetch();
                                        while ($row) {
                                            if ($row_message['recepient'] == "student") {
                                                echo" <div class='row msg_container base_receive'>";
                                                echo "<div class='col-md-2 col-xs-2 avatar'>";
                                                echo " <img src='http://www.bitrebels.com/wp-content/uploads/2011/02/Original-Facebook-Geek-Profile-Avatar-1.jpg' class=' img-responsive '>";
                                                echo" </div>";
                                                echo"<div class='col-md-10 col-xs-10'>";
                                                echo"<div class='messages msg_receive'>";
                                                echo"<p>$row_message[message]</p>";
                                                echo"<time datetime='$row_message[date_created]'></time>";
                                                echo"</div>";
                                                echo"</div>";
                                                echo"</div>";
                                            } elseif ($row_message['recepient'] == "advisor") {
                                                ...
                                                echo"</div>";
                                                echo" <div class='col-md-2 col-xs-2 avatar'>";
                                                echo"<img src='http://www.bitrebels.com/wp-content/uploads/2011/02/Original-Facebook-Geek-Profile-Avatar-1.jpg' class=' img-responsive '>";                                                                                              echo"</div>";
                                                 echo"</div>";  
                                            }
                                         $row_message = $obj_message->fetch();
                                        }
                                    ...
                                    <div class="panel-footer">
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                <button onclick="send_message_to_advisor(<?php print $student_has_advisor_id ?>)" class="btn btn-primary btn-sm" id="btn-chat">Send</button>
                                            </span>
                                        </div>
                                    </div>
                                </div>
